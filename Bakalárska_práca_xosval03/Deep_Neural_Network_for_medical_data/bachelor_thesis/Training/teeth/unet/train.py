...
from bachelor_thesis.Training.teeth.unet.unet.model import UNet # dont delete
from bachelor_thesis.Training.teeth.unet.losses  import LovaszLossSoftmax, LovaszLossHinge, dice_coeff

from config_global import TEETH_DATASET_PATH,TENSORBOARD_TEETH_UNET_PATH,UNET_TEETH_WORKER
...
def train_net(net, cfg):
    ...
    writer = SummaryWriter(log_dir=TENSORBOARD_TEETH_UNET_PATH,comment=f'LR_{cfg.lr}_BS_{cfg.batch_size}_SCALE_{cfg.scale}')
    global_step = 0
