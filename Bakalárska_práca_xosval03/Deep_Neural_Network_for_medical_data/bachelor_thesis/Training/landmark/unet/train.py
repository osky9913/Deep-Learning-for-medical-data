...
from bachelor_thesis.Training.landmark.unet.dataset import TeethDataset
from bachelor_thesis.Training.landmark.unet.config  import UNetConfig
from bachelor_thesis.Training.landmark.unet.unet.model import UNet #dont delete
from bachelor_thesis.Training.landmark.unet.losses  import LovaszLossSoftmax, LovaszLossHinge, dice_coeff
from config_global import LANDMARK_DATASETH_PATH,TENSORBOARD_LANDMARK_UNET_PATH,UNET_LANDMARK_WORKER
...
def train_net(net, cfg):
    ...
    train_loader = DataLoader(train,
                              ...
                              shuffle=True,
                              num_workers=UNET_LANDMARK_WORKER,
                              pin_memory=True)
    ...
    writer = SummaryWriter(log_dir=TENSORBOARD_LANDMARK_UNET_PATH,comment=f'LR_{cfg.lr}_BS_{cfg.batch_size}_SCALE_{cfg.scale}')
    global_step = 0
