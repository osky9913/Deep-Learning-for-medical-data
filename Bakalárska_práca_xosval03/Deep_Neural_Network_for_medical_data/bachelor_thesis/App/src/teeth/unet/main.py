...
from bachelor_thesis.Training.teeth.unet.inference import inference_one
from bachelor_thesis.Training.teeth.unet.train import cfg
from bachelor_thesis.Training.teeth.unet.utils.colors import get_colors
from bachelor_thesis.Training.teeth.unet.unet import UNet# dont delete
...
net.load_state_dict(torch.load("C:\\Users\\mosva\\Documents\\Code\\bachelor_trainning\\pytorch_google_colab\\bachelor_thesis\\selected_checkpoints\\teeth\\unet\\epoch_2.pth", map_location=device))
print("loaded")
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Unet teeth"))
        """
