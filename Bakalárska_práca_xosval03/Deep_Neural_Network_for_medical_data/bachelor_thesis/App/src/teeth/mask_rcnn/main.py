...
class Ui_Dialog(object):
    ...
    def analyze(self):
        mask_rcnn_path = "C:\\Users\\mosva\\Documents\\Code\\bachelor_trainning\\pytorch_google_colab\\bachelor_thesis\\selected_checkpoints\\teeth\\mask-rcnn\\mask-rcnn-model-all0.pt"
        # --------------- INPUT --------------------
